...
import { shape1 ,shape5,shape6, shape7, shape8, shape2, shape3, shape4, shape9, shape13, shape10, shape37, service_img1, shape14, shape15, shape16,  shape31, shape32, shape33, shape34, hero1, hero2, scroll, scroll_bg, ab_shape, phone, mail, about2, about3, about4, about1, portfolio_shape, shape19, shape23, shape38, portfolio_shape1, shape20 } from '../constant'
...
const Home = () => {
      ...
      <div className="row align-items-center">
        ...
        <div className="col-lg-5">
          <div className="hero-image-group">
            ...
            <img
              className="group-image3"
              src={shape5}
              alt="Image"
            />
            <img
              className="group-image4 pulse"
              src={shape6}
              alt="Image"
            />
            <img
              className="group-image5 pulse"
              src={shape7}
              alt="Image"
            />
            <img
              className="group-image6 pulse"
              src={shape8}
              alt="Image"
            />
          </div>
  ...
  <section className="tj-service-section">
    <div className="container">
      ...
      <div className="row">
      {services.filter((service, index)=> index <=3).map((service)=>{
        return(<div
    ...
    <div className="row align-items-end portfolio-header">
      ...
      >
        <div className="tj-sec-heading">
          ...
          <h2 className="sec-title">Our Latest Work For Our Best Customer</h2>
        </div>
      </div>
